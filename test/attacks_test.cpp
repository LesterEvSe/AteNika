...
// Queen Attacks
TEST_F(AttacksTest, queen_in_the_center_of_empty_board) {
    // Arrange & Act
...
TEST_F(AttacksTest, queen_with_blockers) {
    // Arrange
...
// White Pawn
TEST_F(AttacksTest, white_pawn_on_the_left_edge) {
    // Arrange & Act
