...
TEST_F(PerftTest, max_possible_moves_in_position_1) {
    // Arrange
...
TEST_F(PerftTest, initial_position_1) {
    Board board = Board();
...
TEST_F(PerftTest, trouble_position_2) {
...
TEST_F(PerftTest, trouble_position_3) {
...
TEST_F(PerftTest, trouble_position_4) {
...
TEST_F(PerftTest, mirrored_trouble_position_4) {
...
TEST_F(PerftTest, trouble_position_5) {
...
TEST_F(PerftTest, trouble_position_6) {
